...
- Fork the repository on [Github](https://github.com/apulis/diamond)
...
* Clone the remote repository
    ...
    ```shell
    # For GitHub
    git clone https://github.com/{insert_your_forked_repo}/diamond.git
    git remote add upstream https://github.com/diamond-ai/diamond.git
    # For Gitee
    git clone https://gitee.com/{insert_your_forked_repo}/diamond.git
    git remote add upstream https://gitee.com/diamond/diamond.git
    ```
...
* Raise your idea as an *issue* on [GitHub](https://github.com/diamond/diamond/issues)
